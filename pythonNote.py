# Промежуточная контрольная 06 2023
# Приложение заметки
# для первого запуска программы необходимо создать файл с
# именем fileID.txt и сохранить в этом файле 0


import datetime

print("* * * Приложение ЗАМЕТКИ Ver.06.23 * * *")
# print("***Инструкция***" + "\n" + "Команды для работы:" + "\n" +
